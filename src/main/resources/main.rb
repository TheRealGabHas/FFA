...
Bukkit.get_plugin_manager.register_event(EntityDamageEvent.java_class, EntityDamageListener.new, org.bukkit.event.EventPriority::NORMAL, EntityDamageListener.damage_executor($plugin), $plugin)
Bukkit.get_plugin_manager.register_event(EntityDamageByEntityEvent.java_class, EntityDamageListener.new, org.bukkit.event.EventPriority::NORMAL, EntityDamageListener.damage_by_entity_executor($plugin), $plugin)
